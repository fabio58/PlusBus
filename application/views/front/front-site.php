      ...
      <ul>
        <li><img src="<?php echo base_url() ?>public/images/sitios-web.jpg" alt="" />
          <div class="floater">
            ...
            <p class="readmore"><a href="#">Con Quienes Trabajamos</a></p>
          </div>
        </li>

             <li><img src="<?php echo base_url() ?>public/images/demo/2.gif" alt="" />
          <div class="floater">
        ...
        <li><img src="<?php echo base_url() ?>public/images/demo/3.gif" alt="" />
          <div class="floater">
