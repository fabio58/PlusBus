<div class="wrapper col3">
    <div id="container">
        <h1 style="text-align: center"> Webmaster Online</h1>
        <center> <img class="img-thumbnail" src="<?php echo base_url(); ?>public/images/webmaster-online.jpg"></center>
                <p>Webmaster  Oline consiste en que su sitio queda bajo la administración de PLUSMEDIA ya sea si usted tiene modificaciones semanales que realizar y no cuenta con un webmaster, Plusmedia se encarga de ir desarrollando o manteniendo el sitio web por una cuota mensual.</p>
                
                <p class="bene"><b>El servicio Incluye </b></p>
